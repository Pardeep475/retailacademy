...
import '../controller/pod_cast_comment_controller.dart';
import '../widgets/item_no_comment_found.dart';
import '../widgets/item_pod_cast_comment.dart';
import '../widgets/item_sent_comment.dart';
import 'full_screen_image_and_video_screen.dart';

class PodCastCommentScreen extends StatefulWidget {
  final String title;
  final bool hasLike;
  final String itemMediaUrl;
  final int podCastId;

  const PodCastCommentScreen(
      {required this.title,
  ...
  @override
  State<StatefulWidget> createState() => _PodCastCommentScreenState();
}

class _PodCastCommentScreenState extends State<PodCastCommentScreen> {
  final PodCastCommentController _controller =
      Get.isRegistered<PodCastCommentController>()
          ? Get.find<PodCastCommentController>()
          : Get.put(PodCastCommentController());
  ...
  _sendCommentOnPressed() async {
    if (_textController.text.trim().isEmpty) {
      ...
      await _controller.podCastPostCommentsApi(comment: commentText);
      _scrollToBottom();
    }
  }
