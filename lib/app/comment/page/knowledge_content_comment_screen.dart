...
class KnowledgeContentCommentScreen extends StatefulWidget {
  ...
  const KnowledgeContentCommentScreen(
      {required this.title,
  ...
  @override
  State<StatefulWidget> createState() => _KnowledgeContentScreenState();
}

class _KnowledgeContentScreenState
    extends State<KnowledgeContentCommentScreen> {
  final KnowledgeContentCommentController _controller =
      Get.isRegistered<KnowledgeContentCommentController>()
          ? Get.find<KnowledgeContentCommentController>()
          : Get.put(KnowledgeContentCommentController());
